...
public class MainVentas extends javax.swing.JPanel {
    ...
    public MainVentas() {
        ...
        txtCantidad.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                double pu = Double.parseDouble(String.valueOf(txtUnit.getText()));
                txtTotal.setText(String.valueOf(cant * pu));
    ...
    public List<CarritoTO> listarCarrito(String dni) {
        ...
        TableColumn column = jTable2.getColumnModel().getColumn(8);
        column.setCellRenderer(new ButtonsRenderer());
        ButtonsEditor be = new ButtonsEditor(jTable2);
        ...
        btnDel.addActionListener((ActionEvent e) -> {
            ...
            int row
                    = jTable2.convertRowIndexToModel(jTable2.getEditingRow());
        ...
        txtTotaldos.setText(String.valueOf(impoTotal));
        double pv = impoTotal / 1.18;
        txtPrecio.setText(String.valueOf(Math.round(pv * 100.0) / 100.0));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDniAutoComplete, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(txtUnit, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(20, 20, 20)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtTotaldos, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txtTotaldos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        to.setPunitario(Double.parseDouble(txtUnit.getText()));
        to.setPtotal(Double.parseDouble((txtTotal.getText())));
        to.setEstado(1);
...
//CAMINO = Paths.get(ruta+"/"+"reporte1.jrxml");
    ...
    public void registrarVenta() {
        ...
        to.setDniruc(txtDniAutoComplete.getText());
        to.setPreciobase(Double.parseDouble(txtIGV.getText()));
        to.setIgv(Double.parseDouble(txtIGV.getText()));
        to.setPreciototal(Double.parseDouble(txtTotaldos.getText()));
